    ...
    <DefaultLayout>
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl p-6 text-white">
          <h2 className="text-2xl font-bold mb-2">Welcome to IRMS Dashboard</h2>
          <p className="text-indigo-100">
            Manage your candidates, users, and system analytics from this central dashboard.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {[1, 2, 3, 4].map((item) => (
                <div key={item} className="flex items-center space-x-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-900">New candidate registered</p>
          ...
          <Card className="p-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="p-3 bg-indigo-50 hover:bg-indigo-100 rounded-lg transition-colors">
                <div className="text-center">
                  <svg className="w-6 h-6 text-indigo-600 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                  </svg>
                  <p className="text-sm font-medium text-indigo-900">Add Candidate</p>
                </div>
              </button>
              ...
              <button className="p-3 bg-yellow-50 hover:bg-yellow-100 rounded-lg transition-colors">
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium text-yellow-900">Settings</p>
                </div>
              </button>
            </div>
          </Card>
